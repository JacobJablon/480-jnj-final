const poiLocations = [
  {
    ...
    lat: 43.15447789767281,
    lon: -77.60505248322582,
  },
  ...
  {
    name: "Miller Center Quad",
    lat: 43.158032731735524,
    lon: -77.60156959342274,
  },
  { name: "Envative", lat: 43.15914267683912, lon: -77.59787487198305 },
  {
    name: "Rochester Contemporary Art Center Quad",
    lat: 43.15631542372931,
    lon: -77.60050935072933,
  },
...
const isLocationClose = ({ userLat, userLon }, location) => {
  ...
  const dLat = toRad(location.lat - userLat);
  const dLon = toRad(location.lon - userLon);
  const a =
    Math.sin(dLat / 2) ** 2 +
...
const setupMap = (route, zoom = 15, userCoords) => {
  ...
  mapboxgl.accessToken =
    "pk.eyJ1IjoianJqODI1MCIsImEiOiJjbTk3OG9mMWcwNTIyMmpxMmp5ZzNzdWFiIn0.EkdpGr7grUZ8_9FN3l047g";
...
export { poiLocations, setupMap, isLocationClose };
